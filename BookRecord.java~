 ...
 * @param conAuthor The string that holds the contributing author's name.
...
public class BookRecord
{
  ...
  /**
   * The string that holds the contributing author's name.
   */
   ...
   */
  public BookRecord (String title, String author, String conAuthor, String location, String genre, String returnDate)
  {
    this.title = formatName (title);
    this.author = formatName (author);
    this.conAuthor = formatName (conAuthor);
    this.genre = genre;
  ...
  /**
   * This method sets a new contributing author's name.
   * 
   * @param newName String the new author name to be set.
   */ 
  public void setConAuthor (String newAuthor)
  {
    conAuthor = formatName (newAuthor);
  }
